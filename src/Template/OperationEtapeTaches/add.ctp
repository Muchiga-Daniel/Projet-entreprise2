...
<div class="operationEtapeTaches form large-12 medium-8 columns content act">
    <?= $this->Form->create($operationEtapeTach); //debug($operationEtapeTach->utilisateurs_id); die();?>
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('utilisateur_id', ['options' => $utilisateurs, 'default' => $operationEtapeTach->utilisateurs_id]);
            ...
            echo $this->Form->hidden('utilisateurs_id',['value' => $utilisateurs_id]);
        ?>
    </fieldset>
