...
<nav class="large-12 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav btn-li">
        ...
        <li><?= $this->Html->link(__('List etape tâches en cours'), ['action' => 'indexencours']) ?></li>
        <li><?= $this->Html->link(__('New Operation Etape Tache'), ['controller' => 'OperationEtapeTaches', 'action' => 'add']) ?></li>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('tache_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($operationEtapeTach->tach->designation) ?></td>
