...
<div class="operationEtapeTaches form large-12 medium-8 columns content act">
    ...
    <fieldset>
        ...
        <?php
            echo $this->Form->control('date_relance');
    ...
    <span class="boutton"><?= $this->Html->link(__('Etapes suivante'), ['controller' => 'operationEtapeTaches', 'action' => 'addsuivantetape', $operationEtapeTach->operation_id, $operationEtapeTach->id]) ?></span>
